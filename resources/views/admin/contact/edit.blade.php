                             ...
                             @csrf
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" 
                                     id="exampleFormControlInput1" value="{{ $contacts->email }}"
                                ...
                                <div class="form-group">
                                    ...
                                    id="exampleFormControlTextarea1" rows="3">{{ $contacts->phone }}</textarea>
                                    @error('phone')
                                ...
                                <div class="form-group">
                                    ...
                                    id="exampleFormControlTextarea1" rows="3">{{ $contacts->address }}</textarea>
                                    @error('address')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
