          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single" data-aos="fade-up">
              ...
              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="icofont-user"></i> <a href="blog-single.html">{{ $blogs->user_name }}</a></li>
                  <li class="d-flex align-items-center"><i class="icofont-wall-clock"></i> <a href="blog-single.html">
                      <time datetime="2020-01-01">{{ $blogs->created_at }}</time></a>
                  </li>
